...
| 코스 공유  | URL 복사, 카카오톡 직접 공유, OG 메타 지원               |
| 경로 보기  | Google Maps 기반 도보·대중교통 경로 안내, 구간별 선택 보기 |
...
코스에 포함된 장소 목록을 확인하고, 경로 보기·교통수단 보기·공유·좋아요·북마크 기능을 이용할 수 있습니다. 공유 버튼을 누르면 URL 복사 또는 카카오톡 직접 공유를 선택할 수 있으며, 카카오톡으로 공유 시 OG 미리보기(제목·설명·이미지)가 함께 표시됩니다.
...
Google Maps 기반으로 코스 장소들 간의 도보 또는 대중교통 경로를 순서대로 안내합니다. 상단의 구간 선택 버튼으로 전체 경로를 한 번에 보거나, 원하는 구간만 선택해서 볼 수 있습니다.
