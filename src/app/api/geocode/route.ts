...
export async function GET(req: NextRequest) {
  ...
  //   `https://maps.googleapis.com/maps/api/geocode/json?address=${encodeURIComponent(query)}&language=ko&region=KR&key=${process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}`,
  // );
